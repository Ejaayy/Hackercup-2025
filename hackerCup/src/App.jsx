        ...
        <div className={`features-section ${isVisible ? 'fade-in-more-delayed' : ''}`}>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p className="feature-description">Get accurate arrival times and live vehicle tracking for better planning</p>
            </div>

            <div className="feature-card">
              <div className="feature-icon">🎯</div>
              <h3 className="feature-title">Smart Matching</h3>
              <p className="feature-description">Intelligent route matching connects you with the perfect ride</p>
            </div>

            <div className="feature-card">
              <div className="feature-icon">📱</div>
              <h3 className="feature-title">Easy to Use</h3>
              <p className="feature-description">Simple, intuitive interface designed for Filipino commuters</p>
            </div>
          </div>
